...
const Engine = {
	init: function() {
		this.generator = {};
		this.quoteSamplesStore = Object.create(QuoteSamplesStore).init();

		return this;
	}
};

Engine.fillQuoteSampleStore = function() {
	const kaamelottQuoteSamples = Object.create(QuoteSamples).init('Kaamelott', 
	[
		"On devient pas chef",
        "Nous on est Celtes",
	...
	const classicQuoteSamples = Object.create(QuoteSamples).init('Classic', 
	[
...
Engine.createAndStartGenerator = function() {
	this.fillQuoteSampleStore();
	this.generator = Object.create(QuoteGenerator).init('generator-box-1', this.quoteSamplesStore);
